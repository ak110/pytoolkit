...
def _gen():
    ...
    gen.add(tk.image.Resize((32, 32)))
    gen.add(tk.image.RandomTransform(32, 32))
...
def test_image_data_generator_repro(data_dir):
    ...
    g2.close()
    g3.close()
    assert b1_1.shape == (2, 32, 32, 3)
    assert b1_2.shape == (1, 32, 32, 3)
    assert b2_1.shape == (2, 32, 32, 3)
    assert b2_2.shape == (1, 32, 32, 3)
    assert b3_1.shape == (2, 32, 32, 3)
    assert b3_2.shape == (1, 32, 32, 3)
