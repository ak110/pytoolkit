...
def test_filters(data_dir, check_dir):
    ...
    filters = [
        ...
        (0, 'gt_pos_1', lambda rgb: tk.ndimage.geometric_transform(rgb, 256, 256, scale_h=1.5, scale_v=1.5, pos_h=1, pos_v=0)),
        (0, 'gt_pos_2', lambda rgb: tk.ndimage.geometric_transform(rgb, 256, 256, scale_h=1.5, scale_v=1.5, pos_h=0, pos_v=1)),
        (0, 'gt_pos_3', lambda rgb: tk.ndimage.geometric_transform(rgb, 256, 256, scale_h=0.75, scale_v=0.75, pos_h=1, pos_v=0)),
        (0, 'gt_pos_4', lambda rgb: tk.ndimage.geometric_transform(rgb, 256, 256, scale_h=0.75, scale_v=0.75, pos_h=0, pos_v=1)),
